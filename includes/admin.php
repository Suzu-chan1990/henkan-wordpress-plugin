...
function henkan_admin_page() {
    ...
    <div class="wrap henkan-wrap">
        <div class="henkan-header">
            <div class="header-title"><h1><?php esc_html_e( 'Henkan', 'henkan-webp-avif-converter' ); ?> <span class="version">v2.0.4</span></h1></div>
        ...
        <div class="henkan-grid main-content">
            <div class="henkan-col-left">
                <div class="henkan-card">
                    <h2><?php esc_html_e( 'Settings', 'henkan-webp-avif-converter' ); ?></h2>
        ...
        <div class="henkan-section" style="margin-top:10px;">
            ...
            <p style="margin:8px 0 0; color:#666; font-size:12px;">
                <?php esc_html_e( 'The selected converter is strictly used. No auto-fallback.', 'henkan-webp-avif-converter' ); ?>
            </p>
        </div>
...
location ~* ^.+\.(png|jpe?g)$ {
    ...
    try_files $uri$webp_avif_suffix $uri =404;
                ...
                <div class="henkan-card">
                    <h2><?php esc_html_e( 'WP-CLI Commands', 'henkan-webp-avif-converter' ); ?></h2>
