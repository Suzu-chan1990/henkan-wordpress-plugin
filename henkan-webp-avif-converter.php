...
function henkan_enqueue_admin( $hook ) {
    ...
    wp_enqueue_style( 'henkan-admin-style', HENKAN_URL . 'admin-style.css', [], '2.0.4' );
    wp_enqueue_script( 'henkan-admin-script', HENKAN_URL . 'admin-script.js', [ 'jquery' ], '2.0.4', true );
